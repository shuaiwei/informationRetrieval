...
public class Driver extends Configured implements Tool {
	...
	private static final String THIRDDOUTPUT_PATH = "./thirdOutput";
	...
	public int run(String[] args) throws Exception{		
		...
		fs2.delete( new Path(FIRSTOUTPUT_PATH + "/part-r-00000.crc"), true);
		...
		fs3.delete( new Path(FIRSTOUTPUT_PATH + "/part-r-00000.crc"), true);
